...
func (c *homeworkServiceClient) UpdateHomework(ctx context.Context, in *UpdateHomeworkRequest, opts ...grpc.CallOption) (*UpdateHomeworkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *homeworkServiceClient) DeleteHomework(ctx context.Context, in *DeleteHomeworkRequest, opts ...grpc.CallOption) (*DeleteHomeworkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
